/* data-additions.js — 方劑學 v11.6.3 처방별 加減 데이터
 * v11.6.3 : HERB_ALIASES 에서 시험범위 외 처방(氣血雙補·補陰·補陽·
 *           陰陽幷補·溫裏·開竅) 전용 본초 20종 제거 (dead alias 정리).
 *           제거 본초: 飴糖·龍眼肉·山茱萸·龜板·鱉甲·石斛·沙蔘·肉蓯蓉·
 *           巴戟天·蜀椒·茯神·通草·石菖蒲·豬脊髓·麝香·雞血藤·秦艽·
 *           小茴香·猪膽汁·白芨
 * ============================================================================
